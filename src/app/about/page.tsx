    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="max-w-3xl mx-auto">
                <h1 className="text-3xl font-bold text-[var(--ink)] mb-6">About Relax‑App</h1>

                <div className="bg-[var(--surface)] border border-[var(--line)] rounded-lg p-6 backdrop-blur-sm space-y-6">
                    <section>
                        <h2 className="text-xl font-semibold text-[var(--ink)] mb-4">Our Mission</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-[var(--ink)] mb-4">What You&apos;ll Find on the Site</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-[var(--ink)] mb-4">Development Status</h2>
                        <p className="text-[var(--muted)]">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-[var(--ink)] mb-4">How to Help the Project</h2>
                        ...
                        <ul className="list-disc list-inside text-[var(--muted)] space-y-2">
                            <li>
                                ...
                                <a
                                    ...
                                    className="text-[var(--accent)] hover:text-[var(--muted)] transition-colors"
                                >
                                    @yamkin_alex
                                </a>
                            </li>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-[var(--ink)] mb-4">Acknowledgments</h2>
                        <p className="text-[var(--muted)]">
                            Thank you to all ambient video creators for inspiration, and to you — for using Relax‑App. Your feedback helps
                            us grow and develop.
                        </p>
                        <p className="text-[var(--muted)] mt-2">Enjoy your relaxation and productive work!</p>
                    </section>
                </div>
            </div>
        </div>
